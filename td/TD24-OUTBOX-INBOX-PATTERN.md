...
- [ ] Outbox/inbox lag observable via structured logs (unpublished count, oldest-unpublished age, GC deletions, publish failures) — an actual alert path is deferred to `M17-S35` (not yet built; see S05 notes on `M17-S33`/`M17-S35`).
