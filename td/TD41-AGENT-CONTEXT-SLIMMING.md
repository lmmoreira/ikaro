...
- `docs/CI_TRAPS.md` (modify — add the `getByText`-in-E2E entry)
...
- [ ] The five promoted tier-3 patterns (outbox-no-consumer, unescaped LIKE, `onConflict()`, CHECK-constraint-on-live-table, `getByText`-in-E2E) each have a real row in `docs/ANTI_PATTERNS.md` or `docs/CI_TRAPS.md`, and their `context.md` §7 bullets point there instead of `docs/ENGINEERING_RULES.md`.
