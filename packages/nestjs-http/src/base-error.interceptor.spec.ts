...
class TestErrorInterceptor extends BaseErrorInterceptor {
...
describe('BaseErrorInterceptor', () => {
  let logger: ReturnType<typeof makeLogger>;
  let interceptor: TestErrorInterceptor;

  beforeEach(() => {
    logger = makeLogger();
    interceptor = new TestErrorInterceptor(logger as unknown as BaseAppLogger);
  });
