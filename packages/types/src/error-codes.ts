...
export const BookingErrorCode = {
  ...
  TENANT_OPENING_REQUIRED: 'BOOKING_TENANT_OPENING_REQUIRED',
  TENANT_OPENING_HAS_RESOURCE_DEPENDENTS: 'BOOKING_TENANT_OPENING_HAS_RESOURCE_DEPENDENTS',
  ...
  SERVICE_SESSION_NOT_BOOKABLE: 'BOOKING_SERVICE_SESSION_NOT_BOOKABLE',
  ...
  SERVICE_BUFFER_AFTER_MINUTES_INVALID: 'BOOKING_SERVICE_BUFFER_AFTER_MINUTES_INVALID',
  ...
  RESOURCE_NOT_ACTIVE: 'BOOKING_RESOURCE_NOT_ACTIVE',
  ...
  SERVICE_HAS_LEGS: 'BOOKING_SERVICE_HAS_LEGS',
  SERVICE_BOOKING_MODEL_MISMATCH: 'BOOKING_SERVICE_BOOKING_MODEL_MISMATCH',
  SERVICE_LEGS_TOO_FEW: 'BOOKING_SERVICE_LEGS_TOO_FEW',
  SERVICE_BOOKING_MODEL_IMMUTABLE: 'BOOKING_SERVICE_BOOKING_MODEL_IMMUTABLE',
  SERVICE_RESOURCE_TYPE_UNAVAILABLE: 'BOOKING_SERVICE_RESOURCE_TYPE_UNAVAILABLE',
  SERVICE_RESOURCE_REQUIREMENT_INVALID: 'BOOKING_SERVICE_RESOURCE_REQUIREMENT_INVALID',
  SERVICE_LEG_INVALID: 'BOOKING_SERVICE_LEG_INVALID',
  SERVICE_CONCURRENT_MODIFICATION: 'BOOKING_SERVICE_CONCURRENT_MODIFICATION',
  SERVICE_CLASS_RESOURCE_SLOT_DUPLICATE_TYPE: 'BOOKING_SERVICE_CLASS_RESOURCE_SLOT_DUPLICATE_TYPE',
  SERVICE_CLASS_RESOURCE_SLOT_RESOURCE_NOT_ACTIVE:
    'BOOKING_SERVICE_CLASS_RESOURCE_SLOT_RESOURCE_NOT_ACTIVE',
  SERVICE_CLASS_RESOURCE_SLOT_EMPTY_POOL: 'BOOKING_SERVICE_CLASS_RESOURCE_SLOT_EMPTY_POOL',
  SERVICE_CLASS_RESOURCE_SLOT_BOOKING_MODEL_MISMATCH:
    'BOOKING_SERVICE_CLASS_RESOURCE_SLOT_BOOKING_MODEL_MISMATCH',
  SERVICE_DURATION_POLICY_REQUIRES_PRICING: 'BOOKING_SERVICE_DURATION_POLICY_REQUIRES_PRICING',
  SERVICE_BOOKING_CONFIG_MODEL_MISMATCH: 'BOOKING_SERVICE_BOOKING_CONFIG_MODEL_MISMATCH',
  SERVICE_BOOKING_POLICY_INVALID: 'BOOKING_SERVICE_BOOKING_POLICY_INVALID',
  RESOURCE_SELECTION_REQUIRED: 'BOOKING_RESOURCE_SELECTION_REQUIRED',
  BUNDLE_PARTIALLY_UNAVAILABLE: 'BOOKING_BUNDLE_PARTIALLY_UNAVAILABLE',
  LEG_UNAVAILABLE: 'BOOKING_LEG_UNAVAILABLE',
  DURATION_OUT_OF_RANGE: 'BOOKING_DURATION_OUT_OF_RANGE',
  INTAKE_ANSWER_MISSING: 'BOOKING_INTAKE_ANSWER_MISSING',
  INVALID_MULTIPLE_VARIABLE_SERVICES: 'BOOKING_INVALID_MULTIPLE_VARIABLE_SERVICES',
  ATTENDEE_NAME_REQUIRED: 'BOOKING_ATTENDEE_NAME_REQUIRED',
} as const;
