...
run "roles_have_exactly_the_reviewed_permissions" {
  ...
  assert {
    condition     = google_project_iam_custom_role.relay_vm_operator.role_id == "tfFoundationRelayVmOperator" && length(google_project_iam_custom_role.relay_vm_operator.permissions) == 33 && alltrue([for permission in ["cloudsql.instances.get", "cloudsql.users.create", "cloudsql.users.delete", "cloudsql.users.get", "cloudsql.users.list", "cloudsql.users.update", "compute.disks.create", "compute.disks.delete", "compute.disks.get", "compute.disks.use", "compute.firewalls.create", "compute.firewalls.delete", "compute.firewalls.get", "compute.firewalls.list", "compute.firewalls.update", "compute.instances.create", "compute.instances.delete", "compute.instances.get", "compute.instances.getIamPolicy", "compute.instances.list", "compute.instances.setIamPolicy", "compute.instances.setLabels", "compute.instances.setMetadata", "compute.instances.setServiceAccount", "compute.instances.setTags", "compute.machineTypes.get", "compute.networks.get", "compute.networks.use", "compute.subnetworks.get", "compute.subnetworks.use", "compute.zones.get", "iap.tunnelInstances.getIamPolicy", "iap.tunnelInstances.setIamPolicy"] : contains(tolist(google_project_iam_custom_role.relay_vm_operator.permissions), permission)])
