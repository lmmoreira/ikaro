...
# (`foundation/modules/runtime-identities` owns the per-SA accessor bindings — originally
...
# plan/M17-CLOUD-DEPLOY.md's M17-S16 table and in SECRETS.md). Values are populated out-of-band
# by the S27/S37 activation runbooks — never via Terraform (M17 §2).
