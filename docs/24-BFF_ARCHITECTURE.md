...
Full pattern (code catalog, naming convention, frontend resolver, "adding a new error" checklist): `docs/ENGINEERING_RULES.md` § Exception handling & i18n pattern. Full discovery/rollout history: `docs/archive/td/TD23-EXCEPTION-HANDLING-I18N-PATTERN.md`.
