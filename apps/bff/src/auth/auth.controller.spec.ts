...
describe('AuthController', () => {
  ...
  describe('handleGoogleCallback() — staff login path without tenantSlug', () => {
    it('redirects to /auth/error?reason=no-tenant when staff OAuth callback has no tenantSlug', async () => {
      const staffProfile = {
