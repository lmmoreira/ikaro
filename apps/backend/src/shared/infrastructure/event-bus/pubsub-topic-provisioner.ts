...
// Split out of gcp-pubsub-event-bus.adapter.ts (TD37-S05, file-length) — topic/subscription
// auto-provisioning, self-contained plumbing with no dispatch/tracing logic of its own, so
// extracting it can't touch the dispatch()/dispatchTrigger()/dispatchPushMessage() symmetry
