...
import { TENANT_DAY_LOCK_PORT } from './application/ports/tenant-day-lock.port';
...
import { TypeOrmTenantDayLockAdapter } from './infrastructure/repositories/typeorm-tenant-day-lock.adapter';
...
@Module({
  ...
  providers: [
    ...
    { provide: TENANT_DAY_LOCK_PORT, useClass: TypeOrmTenantDayLockAdapter },
