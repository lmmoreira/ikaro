...
const EVENT_BUS_PORT_PATTERN = {
  ...
  message:
    'Publish sites depend on OUTBOX_PUBLISHER/IOutboxPublisher (shared/ports/outbox-publisher.port), not EVENT_BUS — see docs/archive/td/TD24-OUTBOX-INBOX-PATTERN.md D14.',
};
