...
describe('BookingResourceSummaryLine', () => {
  ...
  it("is aria-hidden — the full matched-resource list is exposed via the enclosing booking link's own ariaLabel instead (renderBookingTimelineEvent), not this div", () => {
    render(
      <BookingResourceSummaryLine
        resourceNames={['Camila Duarte', 'Sala 2', 'Secador']}
        compact={false}
