...
6. **All pt-BR strings live in migration seed data.** Do not add new hardcoded pt-BR strings to TypeScript source; follow `docs/ENGINEERING_RULES.md` § Authoring new i18n UI copy keys for new UI copy.
