...
> ⚠️ **SUPERSEDED by `plan/M17-CLOUD-DEPLOY.md` (2026-07-07).** Deploy was reprioritized ahead of observability, and all M14 stories were reconciled against the implemented codebase and merged into M17: S01/S02 → M17-S33 (OTel, OTLP-only), S04 → M17-S34 (collector sidecar replaces the Compose stack), S05/S06 → M17-S35 (Cloud Monitoring dashboards/alerts, core infra) + M17-S54 (business/audit log-based counters) + M17-S55 (Prometheus-style metrics, deferred — split from S35 2026-08-08), S07 → M17-S04, S08 → M17-S05. The self-hosted Grafana/Prometheus/Loki stack described here remains a valid **future option** (activated by swapping the collector exporter config — see M17 D9). Do not implement stories from this file. Kept for historical reference.
