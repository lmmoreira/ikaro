...
- A "spend by tenant" dashboard — MVP visibility is a periodic query against `chatbot_messages`, not new pipeline infrastructure (`docs/04-USE_CASES.md` UC-033; avoids the premature-metrics-infra failure mode `docs/ENGINEERING_RULES_INFRA.md` already documents an incident about)
...
**Agent:** `backend-ts`
**Complexity:** L
**Docs to load:** `docs/04-USE_CASES.md` UC-033, `docs/04-USE_CASES.md` UC-033–UC-036 (Cost Controls & Abuse Prevention), `docs/13-DATABASE_SCHEMA.md` § chatbot tables, `docs/ENGINEERING_RULES_BACKEND.md` § Transactions (PR #267 precedent)
