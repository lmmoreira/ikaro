...
| Item | Location |
|---|---|
| Hardcoded pt-BR strings in migrations and test assertions | Keep seed/test data explicit; use `docs/ENGINEERING_RULES_SHARED.md` for UI-copy localization rules |
