...
|---|---|---|
| `00-lista-aulas.html` | `/{slug}/aulas` | `ClassCatalogPage` |
| `00-tipo-reserva.html` | `/{slug}/aulas/[classTypeId]/reservar` | `ReservaTypePicker` |
| `01-dropin.html` | `/{slug}/aulas/[classTypeId]/reservar/avulsa` | `DropInSessionPicker` |
| `01b-dropin-lotada.html` | mesma rota — sessão lotada selecionada | `DropInSessionPicker` (estado waitlist) |
| `02-dropin-confirmar.html` | `/{slug}/aulas/[classTypeId]/reservar/avulsa/confirmar` | `DropInConfirmPage` |
| `02b-serie-dias.html` | `/{slug}/aulas/[classTypeId]/reservar/serie` | `SeriesBuilderPage` |
| `03-serie-confirmar.html` | `/{slug}/aulas/[classTypeId]/reservar/serie/confirmar` | `SeriesConfirmPage` |
| `04-success-ativo.html` | `/{slug}/aulas/[classTypeId]/reservar/sucesso` | `EnrollmentSuccessPage` |
| `04b-success-waitlist.html` | mesma rota — status WAITLIST | `EnrollmentSuccessPage` (estado fila) |
...
Lista as sessões futuras do tipo de aula, ordenadas por `startsAt`. Usada na tela `01-dropin.html`.
...
Lista os padrões recorrentes do tipo de aula (um por `ClassScheduleTemplate` ativo). Usada na tela `02b-serie-dias.html` para o cliente montar sua sequência.
...
| `00-lista-aulas.html` | ✅ completo | Catálogo de aulas do tenant |
| `00b-lista-aulas-vazia.html` | ✅ completo | Estado vazio — filtro "Com vagas" sem resultado (adicionada 2026-08-21) |
| `00-tipo-reserva.html` | ✅ completo | Bifurcação avulsa/série |
| `01-dropin.html` | ✅ completo | Seleção de sessão drop-in com badges de vagas |
| `01b-dropin-lotada.html` | ✅ completo | Sessão lotada → entrada na fila |
| `02-dropin-confirmar.html` | ✅ completo | Confirmação drop-in |
| `02b-serie-dias.html` | ✅ completo | Montagem de série (slots + data de início + preview) |
| `03-serie-confirmar.html` | ✅ completo | Confirmação série |
| `04-success-ativo.html` | ✅ completo | Sucesso — vaga garantida (ACTIVE) |
| `04b-success-waitlist.html` | ✅ completo | Sucesso — na fila (WAITLIST) |
