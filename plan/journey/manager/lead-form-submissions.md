...
flowchart TD
    ...
    Submissions --> TypeSearch(("Digita na busca básica (>= 3 caracteres)"))
    ...
    Advanced --> ApplyFilters(("'Aplicar filtros'"))
    ...
    Submissions --> SetDateRange(("Define 'De' / 'Até'<br/>(independente de busca/filtros)"))
