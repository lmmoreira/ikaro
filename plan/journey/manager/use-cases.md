...
| UC-044 | Manager Views the Resource List | Promoted 2026-08-31 from `docs/discovery/multivertical-booking/` for `M21` (Cluster 1/Foundation). Draft — not yet shipped, no story assigned. | `manager/resources.md` |
